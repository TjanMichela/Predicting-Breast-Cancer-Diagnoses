---
title: "An R Markdown document converted from \"breast-cancer-predictive-model.ipynb\""
output:
...
```{r}
data <- read_csv("Coimbra_breast_cancer_dataset.csv")
